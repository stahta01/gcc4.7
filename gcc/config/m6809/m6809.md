...
(define_insn "tstqi"
  [(set (cc0) (match_operand:QI 0 "nonimmediate_operand" "q,tm,z"))]
  ""
  "@
   tst%0
   tst\t%0
   ;tstz"
   [(set_attr "length" "1,3,0")])
...
(define_insn "addhi3"
  [(set (match_operand:HI 0 "nonimmediate_operand"      "=d, d,  d,  a,?a, a,???T,a")
    (plus:HI(match_operand:HI 1 "whole_general_operand" "%0, 0,  0,  d, 0, a, 0, a")
  ...
  ""
{
  ...
  {
     emit_insn (gen_mulqihi3 (operands[0], operands[1], operands[2]));
     DONE;
  } */
...
(define_peephole2
  [(set (reg:HI HARD_X_REGNUM) (mem:HI (reg:HI HARD_X_REGNUM)))
   (set (match_operand:HI 0 "general_operand" "") (reg:HI HARD_X_REGNUM))
   (set (reg:HI HARD_X_REGNUM)
      (mem:HI (plus:HI (reg:HI HARD_X_REGNUM) (const_int 2))))
   (set (match_operand:HI 1 "general_operand" "") (reg:HI HARD_X_REGNUM))]
  "reload_completed"
