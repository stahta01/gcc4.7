...
(define_insn "addqi3"
  [(set (match_operand:QI 0 "nonimmediate_operand"       "=q, q, q, tm, tm, q,   q")
    (plus:QI (match_operand:QI 1 "whole_general_operand" "%0, 0, 0, 0,  0,  0,   0")
    (match_operand:QI 2 "whole_general_operand"          " 0, I, N, I,  N,  tmi, q")))]
  ""
  "@
...
(define_insn "subqi3"
  [(set (match_operand:QI 0 "register_operand"            "=q, q, !q, !q,   q, q")
    (minus:QI (match_operand:QI 1 "whole_register_operand" "0, 0,  I,  tmn, 0, 0")
    (match_operand:QI 2 "whole_general_operand"            "I, mi, 0,  0,   t, q")))]
  ""
  "@
   dec%0
   sub%0\t%2
